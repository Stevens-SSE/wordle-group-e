...
# transfers only 5 letter words from words.txt to new_words.txt
...
# function for logging the game information to the gameplay.log file
    def write_logs(self, message, log_type_error=False):
        if not os.path.exists("gameplay.log"):
            file = open('gameplay.log', 'a+')
        logging.basicConfig(filename="gameplay.log",
